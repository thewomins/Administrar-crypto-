...
class Menu_agregar_dolar:
    ...
    def show_formulario(self, padre, color):
        ...
        a.grid(row=0, columnspan=2, padx=10)
        aa.grid(row=1, columnspan=2, padx=15)
        c=self.components.text(contenedor_texto, "Cantidad comprada", color, 14)
        cc=self.components.entry_txt(contenedor_texto)
        c.grid(row=2, column=0, padx=10, sticky=("w"))
        cc.grid(row=3, column=0, padx=15, sticky=("w"))
        d=self.components.text(contenedor_texto, "Cantidad en CLP", color, 14)
        dd=self.components.entry_txt(contenedor_texto)
        d.grid(row=2, column=1, padx=10, sticky=("w"))
        dd.grid(row=3, column=1, padx=15, sticky=("w"))
        datos=aa,cc,dd
