...
class Menu_vender_crypto:
    ...
    def show_formulario(self, padre, color):
        ...
        a=self.components.text(contenedor_texto, "Cuenta origen (crypto)", color, 14)
        ...
        b=self.components.text(contenedor_texto, "Cuenta destino (usd)", color, 14)
        ...
        c=self.components.text(contenedor_texto, "Cantidad vendida", color, 14)
        ...
        d=self.components.text(contenedor_texto, "Precio de venta", color, 14)
